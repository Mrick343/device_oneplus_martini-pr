...
PRODUCT_BUILD_PROP_OVERRIDES += \
    PRIVATE_BUILD_DESC="MT2111_IND-user 13 TP1A.220905.001 R.120a4bf-1-2 release-keys" \
    TARGET_DEVICE=$(PRODUCT_SYSTEM_DEVICE) \
    TARGET_PRODUCT=$(PRODUCT_SYSTEM_NAME)

BUILD_FINGERPRINT := OnePlus/MT2111_IND/OP5155L1:13/TP1A.220905.001/R.120a4bf-1-2:user/release-keys

# Rise Stuff
RISING_CHIPSET := snapdragon 888 5G
RISING_MAINTAINER := Mrick343
